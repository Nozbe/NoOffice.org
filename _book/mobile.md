...
[^2]: There are many apps for that. In the past, I used to use [Evernote](https://Evernote.com) or [ScanPro+](https://scanbot.io). It's even built into [iOS for iPhone and iPad](https://support.apple.com/en-us/HT210336).
[^3]: The usual suspects include [Dropbox](https://www.dropbox.com), [Box](https://box.com), [Google Drive](https://drive.google.com) and [Microsoft One Drive](https://www.microsoft.com/en-us/microsoft-365/onedrive/online-cloud-storage).
[^4]: The salary formula discussed in 13 in our team is a shared online spreadsheet document in [Apple's Numbers app](https://www.apple.com/iwork/). Alternatives include [Google Spreadsheets](https://www.google.com/sheets/about/) or the good old [Microsoft 365 Excel](https://www.microsoft.com/en-us/microsoft-365/excel).
[^5]: 2FA or MFA stands for [Multi Factor Authentication](https://en.wikipedia.org/wiki/Multi-factor_authentication).
[^6]: Some chat apps that boast encryption include [Apple's iMessage](https://support.apple.com/explore/messages), [Telegram](https://telegram.org), [WhatsApp](https://www.whatsapp.com) or [Signal](https://www.signal.org).
...
[^10]: [VPN stands for Virtual Private Network](https://en.wikipedia.org/wiki/Virtual_private_network), which basically means you can use the Internet to connect computers as if they were directly connected in the same physical space.
