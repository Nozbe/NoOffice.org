...
Once the conversation is finished, I upload the recording to our video storage solution[^7] and set it up in such a way that only people from my team can watch it and nobody else.
