...
> If you see something that takes you **an additional 1 minute** each time you do it and you see it can be improved, feel free to spend around **1 hour** to fixing and optimizing it.

When it applies to the team, it's even more:

> When you see **everyone on your team wastes 1 minute** in certain activity and you have an idea how to improve it, feel free to spend up to **4 hours** making it better.
...
It's not easy. People are used to doing the things they always used to. You have to be patient. You have to set an example. You have to *keep on keepin' on*. Here are some ideas we used to start implementing lean.

### Idea 1. Schedule feedback events.

Just as I described at the end of last chapter on deciding, we very often schedule a *lessons-learned* meeting where we review our past decision and see if there's anything we can improve. The goal of this meeting is to think about all the ways things can be done in a better way in the future.
...
### Idea 2. Make feedback loops integral part of whatever you do.

Remember the "Pyramid of Communication"? The second level of it is *feedback* and there's a reason for it. This way we make giving feedback to people *a thing we do*. And with that, improvement suggestions will follow. After all, it's easier to suggest improvements to other people's work, not yours.

As mentioned in past chapters, we add comments to tasks, to paragraphs of documents and also to code, when someone does a "code review" of other programmer's work.
...
This is something we need to practice more in our team. Record a short video or screen capture of how you've optimized something or you've reduced the number of steps to getting your task done. Quickly explain what was frustrating, how you went about fixing it and how it works now after you've improved it.
